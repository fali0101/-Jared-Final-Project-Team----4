...
// # Pattern: drifting sea animals, bubbles, falling scratch bits, pressed paw tips.
// # Function: random motion without scoring.
// # Color: pale ocean and quiet particles.
// # PawPlay Modes
...
function mousePressed() {
  ...
  if (gameState === 'scratch') {
    if (overButton(buttons.clear)) { scratches = []; debris = []; lastScratch = null; return false; }
...
function mouseDragged() {
  if (gameState === 'scratch') addScratchAt(mouseX, mouseY, pmouseX, pmouseY);
  return false;
}
